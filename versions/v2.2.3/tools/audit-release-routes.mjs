...
async function main() {
  ...
  if (write) {
    ...
    await writeFile(path.join(REPORT_DIR, 'route-release-audit-2.2.3.json'), `${JSON.stringify(report, null, 2)}\n`);
    await writeFile(path.join(REPORT_DIR, 'ROUTE_RELEASE_AUDIT_2_2_3.md'), markdownReport(report));
  }
